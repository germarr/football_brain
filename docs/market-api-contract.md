...
**Only five Competitions exist here.** The Premier League (39), La Liga (140), MLS (253),
Liga MX (262) and Leagues Cup (772) are what either Exchange lists. Anything else is
`not_covered`, permanently.

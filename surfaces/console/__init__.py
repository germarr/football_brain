...
fixtures, and the per-match Match Tracker now live in the Viewer (`surfaces.viewer.app`), which
...
spawns — separate OS processes, however this app is hosted. `python -m surfaces.console`
